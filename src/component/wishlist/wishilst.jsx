...
const Wishlist = ({ books, onDelete, onAddToCart }) => {
                    ...
                    <div className="product-details mb-3">
                        ...
                        {wishBooks.length === 0 ?
                            <div className="conatiner text-center mt-5 mx-5">
                                <h4>You haven’t Liked an item yet!</h4>
                                <p className="mt-5 mr-5 h6 text-muted">Found something you like? Tap on the heart shaped icon next to the item to add it to your Liked!
                                    All your Liked items will appear here.</p>
                                <Link to={"/allbooks"}>
                            ...
                            (wishBooks).map((book) => (
                                <div className="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                                    ...
                                    <div className="d-flex flex-row align-items-center">
                                        ...
                                        <button className="btn btn-primary ml-3" onClick={() => addToCart(book)}>Add to Cart</button>
                                        <i
